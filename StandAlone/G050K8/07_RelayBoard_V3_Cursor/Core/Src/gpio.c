...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, DIP_LATCH_Pin|DIP_CLOCK_Pin|TEMP_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : DIP_DATA_Pin */
  GPIO_InitStruct.Pin = DIP_DATA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(DIP_DATA_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : DIP_LATCH_Pin DIP_CLOCK_Pin TEMP_LED_Pin */
  GPIO_InitStruct.Pin = DIP_LATCH_Pin|DIP_CLOCK_Pin|TEMP_LED_Pin;
